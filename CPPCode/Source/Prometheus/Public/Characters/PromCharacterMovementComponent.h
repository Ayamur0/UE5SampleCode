...
#include "PromCharacterMovementComponent.generated.h"

/**
 * 
 */
UCLASS()
class PROMETHEUS_API UPromCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	UPromCharacterMovementComponent();
